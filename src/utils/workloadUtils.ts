 ...
 */
export function calcGini(scores: number[] | null | undefined): number {
 ...
 */
export function normalizeScore(value: number, min = 0, max = 60): number {
 ...
 */
export function scoreToRisk(score: number): 'critical' | 'high' | 'medium' | 'low' {

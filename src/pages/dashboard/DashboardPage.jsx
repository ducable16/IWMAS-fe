  ...
  return (
    <div className="space-y-6 max-w-[1200px] mx-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard icon={FolderKanban} label="Active projects" value="8" trend={12} variant="accent" delay={0} />
        <StatCard icon={Layers} label="Current sprint" value="Sprint 15" sub="62% complete" variant="default" delay={40} />
        <StatCard icon={CheckSquare} label="Tasks this week" value="47" trend={-3} variant="default" delay={80} />
        <StatCard icon={Users} label="Team members" value="12" sub="2 at risk" variant="warning" delay={120} />
      </div>
        ...
        <div className="flex-1 min-w-0">
          <p className="text-[13px] text-text-primary leading-snug">
            ...
            <span className="text-text-secondary">
              Sprint 15 has a medium risk of missing its deadline. Marcus Rivera is near burnout threshold.
              Consider redistributing 3 tasks to Sarah Chen (workload: 34/100).
            </span>
          </p>
        </div>
        <Link

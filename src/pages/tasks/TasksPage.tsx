...
// ─── Active filter chips ──────────────────────────────────────────────────────
function ActiveChips({ filters, users, projects, onChange, onClearAll }: ActiveChipsProps) {
  ...
  ;(filters.statuses || []).forEach((s) =>
    chips.push({
      key: `status-${s}`,
      label: STATUS_META_BY_KEY[s]?.label ?? s,
  ...
  ;(filters.priorities || []).forEach((p) =>
    chips.push({
      key: `priority-${p}`,
      label: PRIORITY_META_BY_KEY[p]?.label ?? p,
  ...
  ;(filters.types || []).forEach((t) =>
    chips.push({
      key: `type-${t}`,
      label: TYPE_META_BY_KEY[t]?.label ?? t,
  ...
  if (filters.assigneeId) {
    ...
    chips.push({
      key: 'assigneeId',
      label: `Assignee: ${u?.fullName ?? filters.assigneeId}`,
  ...
  if (filters.reporterId) {
    ...
    chips.push({
      key: 'reporterId',
      label: `Reporter: ${u?.fullName ?? filters.reporterId}`,

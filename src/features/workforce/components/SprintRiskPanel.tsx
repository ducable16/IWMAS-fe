import { ShieldAlert, Clock, Users, TrendingDown, AlertCircle, type LucideIcon } from 'lucide-react'
import clsx from 'clsx'

type Severity = 'low' | 'medium' | 'high'

const RISK_DATA = {
  overall: 'medium' as Severity,
  score: 62,
  factors: [
  ...
  overall: Severity
  score: number
  factors: Array<{ icon: LucideIcon; label: string; severity: Severity; detail: string }>
}

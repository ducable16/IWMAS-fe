...
type WorkloadScoreCardProps = {
  member: WorkloadScoreMember
  delay?: number
}
...
export default function WorkloadScoreCard({ member, delay = 0 }: WorkloadScoreCardProps) {
  const {
    score = 0,
    name = 'Unknown',
    role = 'Member',

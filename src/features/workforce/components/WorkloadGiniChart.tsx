...
const CustomBar = ({ x = 0, y = 0, width = 0, height = 0, score, payload }: CustomBarProps) => {
  const value = score ?? payload?.score ?? 0
  return <rect x={x} y={y} width={width} height={height} fill={getBarColor(value)} rx={2} />
}

...
export default function ProjectAddMemberModal({ open, projectId, onClose }: ProjectAddMemberModalProps) {
  ...
  const validate = () => {
    ...
    if (
      ...
      Number.isNaN(Number(form.allocatedEffortPercent)) ||
          ...
          <div className="grid grid-cols-2 gap-4">
            <Field label="Role" required>
              <select
                ...
                onChange={(e) => set('roleInProject', e.target.value as ProjectRole)}

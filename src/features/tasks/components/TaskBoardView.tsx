...
type BoardStatus = typeof COLUMN_CONFIG[number]['key']
type GroupedTasks = Record<TaskStatus, TaskListItem[]>
...
export default function TaskBoardView({ filters }: TaskBoardViewProps) {
  ...
  const statusMutation = useMutation({
    mutationFn: ({ taskId, status }: UpdateStatusVariables) => taskService.updateStatus(taskId, { status }),
    onError: (err: unknown) => {
